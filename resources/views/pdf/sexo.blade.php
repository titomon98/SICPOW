...
<head>
    ...
    <title>Reporte de sexo de la poblacion</title>
    <style>
        body {
            margin: 0;
...
<body>
    ...
    <div class="izquierda">
        <p><strong>Total de personas de sexo masculino: </strong>{{$cont1}} </p>
        <p><strong>Total de personas de sexo femenino: </strong>{{$cont2}} </p>
    </div>
</body>
</html>